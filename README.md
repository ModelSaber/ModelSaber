...
### Scope
The scope could be anything specifying file of the commit change.
...
A detailed explanation can be found in this [AngularJS convensions document](https://docs.google.com/document/d/1QrDFcIiPjSLDn3EL15IJygNPiHORgU1_OOAqWjiDU5Y/edit#).